...
La idea nace de la investigación realizada por Grzegorz Tworek [NPPSy](https://github.com/gtworek/PSBits/tree/master/PasswordStealing/NPPSpy) que aprovecha las capacidades de la API de Windows para generar una DLL persistente, "escuchando" el sistema y capturando las credenciales ingresadas por el usuario en un inicio de sesión de una máquina objetivo (Windows OS).
